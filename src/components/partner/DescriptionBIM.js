...
import plaquette from '@/img/plaquette_master_bim.png' ;
import React from 'react';

const DescriptionBIM = () => {
  return (
        ...
        <div className="row g-5">
          <div className="col-lg-7">
            <div className="section-title position-relative pb-3 mb-5">
              <h1 className="mb-0">Master Executif BIM TO CIM From Building Performance to Territorial Management</h1>
            </div>
          ...
          <div className="col-lg-5" style={{ minHeight: '500px' }}>
            <div className="position-relative h-100">
              <img className="position-absolute w-100 h-70  rounded wow zoomIn" data-wow-delay="0.9s" src={plaquette} style={{ objectFit: 'cover' }} alt="Master BIM" />
            </div>
          </div>
        </div>
      </div>
