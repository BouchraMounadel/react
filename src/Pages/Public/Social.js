    ...
    <div>
      <header style={headerStyle}>
        <div style={{ display: 'flex', alignItems: 'center', flex: '1' }}>
          ...
          <h1 style={titleStyle}>Rehamna : un regard socio-économique à travers les indicateurs clés</h1>
        </div>
        <button style={buttonStyle} className="back-button" onClick={retourAccueil}>
          Retour
        </button>
      </header>
      <iframe allowFullScreen style={iframeStyle} src="http://localhost:8082/mapstore/dashboard-embedded.html#/877"></iframe>
    </div>
  );
};
