    ...
    <div>
      <header style={headerStyle}>
        <div style={{ display: 'flex', alignItems: 'center', flex: '1' }}>
          ...
          <h1 style={titleStyle}>Rehamna à travers les siècles : récits d'une province en mutation</h1>
        </div>
        <button style={buttonStyle} className="back-button" onClick={retourAccueil}>
          Accueil
        </button>
      </header>
      <iframe allowFullScreen style={iframeStyle} src="http://localhost:8082/mapstore/geostory-embedded.html#/293"></iframe>
    </div>
  );
};
