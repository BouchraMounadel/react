    ...
    <div>
      <header style={headerStyle}>
        <div style={{ display: 'flex', alignItems: 'center', flex: '1' }}>
          ...
          <h1 style={titleStyle}>La femme Rehamnaie: de l'analphabètisme à l'autonomisation</h1>
        </div>
        <button style={buttonStyle} className="back-button" onClick={retourAccueil}>
          Accueil
        </button>
      </header>
      <iframe allowFullScreen style={iframeStyle} src="http://localhost:8082/mapstore/#/geostory/shared/1114"></iframe>
    </div>
  );
};
