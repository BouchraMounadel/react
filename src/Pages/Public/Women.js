    ...
    <div>
      <header style={headerStyle}>
        <div style={{ display: 'flex', alignItems: 'center', flex: '1' }}>
          ...
          <h1 style={titleStyle}>Mise en situation de la femme Rehamnaie</h1>
        </div>
        <button style={buttonStyle} className="back-button" onClick={retourAccueil}>
          Retour
        </button>
      </header>
      <iframe allowFullScreen style={iframeStyle} src="http://localhost:8082/mapstore/dashboard-embedded.html?connections=true#/207"></iframe>
    </div>
  );
};
